 ...
 */}
      ...
      <Grid>
        ...
        <div>
          <SlideUp className="md:my-10 lg:my-20 md:mr-20">
            <h2 className="text-3xl lg:text-5xl font-bold text-black mb-4">Innovative Value</h2>
            <p className="font-bold mb-4">Anything that belongs in source code or a data.</p>
    ...
    <Section className="bg-black text-white">
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-5">
        <SlideUp className="bg-white/20 text-center p-8">
          ...
          <p>We have the expertise you need in architecture, and execution for upgrading existing platforms.</p>
        </SlideUp>
        <SlideUp className="bg-white/20 text-center p-8">
          <h3 className="text-2xl font-bold mb-4">Partnership & Coaching</h3>
          <p>While collaborating, we provide training and mentoring.</p>
        </SlideUp>
        <SlideUp className="bg-white/20 text-center p-8">
          <h3 className="text-2xl font-bold mb-4">Low Overhead</h3>
          <p>We do not oversell services. Never. For sure.</p>
        </SlideUp>
        <SlideUp className="bg-white/20 text-center p-8">
          <h3 className="text-2xl font-bold mb-4">Real-world Experience</h3>
          <p>We are uniquely prepared to provide reliable lessons learned from real-world experience.</p>
        </SlideUp>
      </div>
    </Section>
    ...
    <Section>
      <h2 className="text-center text-3xl lg:text-5xl font-bold text-black mb-4">
        Our best sales pitch is our track 
      </h2>
    ...
    >
      <Grid className="min-h-[500px]">
        ...
        <FadeIn className="lg:p-12 md:py-4 md:pr-8">
          <h2 className="text-3xl lg:text-5xl font-bold text-black mb2">Be ready</h2>
